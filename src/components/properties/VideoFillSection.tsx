...
import { CheckboxInput, NumberInput, SelectInput } from "@/components/ui/PropertyInputs";
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="group/video-preview relative overflow-hidden rounded border border-border-light bg-secondary">
        <video
          ...
          style={{ objectFit: fillModeToObjectFit(video.mode) as React.CSSProperties["objectFit"] }}
